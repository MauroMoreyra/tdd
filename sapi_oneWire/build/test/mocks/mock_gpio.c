...
void mock_gpio_Verify(void)
{
  ...
  if (Mock.gpioInit_IgnoreBool)
    Mock.gpioInit_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_gpioInit);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.gpioInit_CallInstance, cmock_line, CMockStringCalledLess);
...
bool_t gpioInit(gpioMap_t gpio, gpioInit_t config)
{
  ...
  if (Mock.gpioInit_CallbackFunctionPointer != NULL)
  {
    return Mock.gpioInit_CallbackFunctionPointer(gpio, config, Mock.gpioInit_CallbackCalls++);
  }
  ...
  {
    UNITY_SET_DETAILS(CMockString_gpioInit,CMockString_gpio);
...
void CMockExpectParameters_gpioInit(CMOCK_gpioInit_CALL_INSTANCE* cmock_call_instance, gpioMap_t gpio, gpioInit_t config)
{
...
void gpioInit_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, bool_t cmock_to_return)
{
  ...
  Mock.gpioInit_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.gpioInit_IgnoreBool = (int)1;
}
...
void gpioInit_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, gpioMap_t gpio, gpioInit_t config, bool_t cmock_to_return)
{
  ...
  CMockExpectParameters_gpioInit(cmock_call_instance, gpio, config);
  cmock_call_instance->ReturnVal = cmock_to_return;
  UNITY_CLR_DETAILS();
}
...
bool_t gpioWrite(gpioMap_t gpio, bool_t value)
{
  ...
  if (Mock.gpioWrite_CallbackFunctionPointer != NULL)
  {
    return Mock.gpioWrite_CallbackFunctionPointer(gpio, value, Mock.gpioWrite_CallbackCalls++);
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  cmock_line = cmock_call_instance->LineNumber;
  if (cmock_call_instance->CallOrder > ++GlobalVerifyOrder)
...
void CMockExpectParameters_gpioWrite(CMOCK_gpioWrite_CALL_INSTANCE* cmock_call_instance, gpioMap_t gpio, bool_t value)
{
  memcpy(&cmock_call_instance->Expected_gpio, &gpio, sizeof(gpioMap_t));
...
void gpioWrite_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, gpioMap_t gpio, bool_t value, bool_t cmock_to_return)
{
  ...
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
  CMockExpectParameters_gpioWrite(cmock_call_instance, gpio, value);
  cmock_call_instance->ReturnVal = cmock_to_return;
  UNITY_CLR_DETAILS();
}
...
bool_t gpioRead(gpioMap_t gpio)
{
  ...
  if (Mock.gpioRead_CallbackFunctionPointer != NULL)
  {
    return Mock.gpioRead_CallbackFunctionPointer(gpio, Mock.gpioRead_CallbackCalls++);
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  cmock_line = cmock_call_instance->LineNumber;
  if (cmock_call_instance->CallOrder > ++GlobalVerifyOrder)
  ...
  if (cmock_call_instance->CallOrder < GlobalVerifyOrder)
    UNITY_TEST_FAIL(cmock_line, CMockStringCalledLate);
  {
    UNITY_SET_DETAILS(CMockString_gpioRead,CMockString_gpio);
    UNITY_TEST_ASSERT_EQUAL_MEMORY((void*)(&cmock_call_instance->Expected_gpio), (void*)(&gpio), sizeof(gpioMap_t), cmock_line, CMockStringMismatch);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
...
void CMockExpectParameters_gpioRead(CMOCK_gpioRead_CALL_INSTANCE* cmock_call_instance, gpioMap_t gpio)
{
  memcpy(&cmock_call_instance->Expected_gpio, &gpio, sizeof(gpioMap_t));
}
...
void gpioRead_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, gpioMap_t gpio, bool_t cmock_to_return)
{
  ...
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
  CMockExpectParameters_gpioRead(cmock_call_instance, gpio);
  cmock_call_instance->ReturnVal = cmock_to_return;
  UNITY_CLR_DETAILS();
}
